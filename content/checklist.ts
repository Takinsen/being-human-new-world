...
export const firstWeek: ChecklistItem[] = [
  { id: "rabbit", title: "ถ้านั่งรถไฟฟ้าทุกวัน ทำบัตร Rabbit และรู้ค่ารถจากที่พักถึงจุฬาฯ", href: "/guides/rabbit", category: "transport" },
  { id: "bus", title: "รู้ว่าขึ้นรถป๊อปและรถเมล์ผ่านจุฬาฯ ยังไง", href: "/guides/pop-bus", category: "transport" },
